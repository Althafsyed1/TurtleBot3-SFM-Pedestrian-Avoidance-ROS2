...
storage_options = StorageOptions(
    uri='/home/althafsyed/ros2_ws/dwb_dynamic_run2/dwb_dynamic_run2_0.mcap',
    storage_id='mcap')
...
print(f"DWB Dynamic Run 2 Metrics:")
...
print(f"Social behavior: Reactive obstacle avoidance only")
